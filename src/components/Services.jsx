...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Professional drywall installation and repair services to create smooth, flawless walls and ceilings for your home or office.",
    },
    {
      icon: Building2,
      title: "Popcorn Ceiling Removal",
      description:
        "Remove outdated popcorn ceilings and give your home a modern, smooth finish with expert craftsmanship.",
    },
    {
      icon: SlidersHorizontal,
      title: "Mudding & Taping",
      description:
        "Expert mudding and taping services to ensure seamless joints and smooth wall surfaces, perfect for painting or finishing.",
    },
    {
      icon: Hammer,
      title: "Kitchen & Bathroom Remodeling",
      description:
        "Transform your kitchen and bathrooms into luxurious, functional spaces that add value to your home.",
    },
    {
      icon: Briefcase,
    ...
    },
    {
      ...
      description:
        "Creative interior solutions that blend aesthetics with functionality for stunning results.",
    },
    {
      icon: PaintBucket,
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all cursor-pointer"
              >
                <div className="w-16 h-16 bg-linear-to-br from-gray-700 to-gray-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <section className="py-20 px-4 flex justify-center mt-10">
            ...
            >
              ...
              <p className="text-gray-300 mb-8 text-lg relative z-10">
                Get expert advice and a free quote for your drywall, framing, or space
